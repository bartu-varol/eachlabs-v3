...
export const hero = {
  ...
  ctas: [
    { label: 'Start Building',         href: '/sign-up',  variant: 'primary'   as const },
...
export const customerStories = {
  ...
  caseStudies: [
    ...
    },
    {
      ...
      name: 'Furkan Sandal',
      role: 'PixelByte',
      avatar: { initials: 'FS', bg: 'bg-ok', text: 'text-white', photo: '/customers/photos/furkan-sandal.png' },
    ...
    },
    {
      ...
      name: 'Osman Menci',
      role: 'Yoya Mobile',
      avatar: { initials: 'OM', bg: 'bg-brand-deep', text: 'text-white', photo: '/customers/photos/osman-menci.png' },
    ...
    },
    {
      ...
      name: 'Ekin Dursun',
      role: 'Pixel Wizard',
      avatar: { initials: 'ED', bg: 'bg-glow', text: 'text-white', photo: '/customers/photos/ekin-dursun.jpeg' },
    ...
    },
    {
      ...
      name: 'Gökçe Oğuz',
      role: 'baby.ai',
      avatar: { initials: 'GO', bg: 'bg-caution', text: 'text-surface', photo: '/customers/photos/gokce-oguz.svg' },
    ...
    },
    {
      ...
      avatar: { initials: 'FG', bg: 'bg-brand', text: 'text-white', photo: '/customers/photos/fatih-guler.svg' },
    ...
    },
    {
      ...
      name: 'Umut Gül',
      role: 'Wask',
      avatar: { initials: 'UG', bg: 'bg-cobrand', text: 'text-white', photo: '/customers/photos/umut-gul.svg' },
    ...
    },
    {
      ...
      name: 'Cihat İmamoğlu',
      role: 'JoyoLabs',
      avatar: { initials: 'Cİ', bg: 'bg-ok', text: 'text-white', photo: '/customers/photos/cihat-imamoglu.svg' },
    ...
    },
    {
      ...
      name: 'Selimhan Çakır',
      role: 'MobileOcean',
      avatar: { initials: 'SÇ', bg: 'bg-brand-deep', text: 'text-white', photo: '/customers/photos/selimhan-cakir.svg' },
