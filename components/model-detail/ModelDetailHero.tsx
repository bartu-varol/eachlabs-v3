        ...
        <div className="flex flex-col gap-6">
          <div>
            <div className="flex items-start justify-between gap-4">
              <h1 className="flex-1 font-sans text-[clamp(26px,3.2vw,36px)] leading-[1.1] tracking-tightest text-ink">
                {headline}
              </h1>
            ...
            {subtitle && (
              <p className="text-body text-ink-muted leading-[1.55] mt-3 w-full">{subtitle}</p>
            )}
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5">
            <Link
              href="/sign-up"
              className="group relative inline-flex w-full items-center justify-center gap-2 px-4 py-3 rounded-md bg-brand text-on-brand text-body font-semibold tracking-tight hover:bg-brand-deep transition-colors shadow-[0_10px_30px_-12px_rgb(var(--brand)/0.55)] hover:shadow-[0_14px_36px_-10px_rgb(var(--brand)/0.75)]"
            >
              <span>Try it on</span>
              <span
                aria-hidden
